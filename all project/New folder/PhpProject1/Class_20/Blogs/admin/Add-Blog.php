...
$message='';
$queryResult=Add_category::GetAllCategory();
                    ...
                    <table>
                        <tr>
                            ...
                            <select class="form-control" name="blog_title">
                                <?php while ($publishCategory=mysqli_fetch_assoc($queryResult));?>
                                <option value="1"><?php echo $publishCategory['blog_title']; ?></option>
                        ...
                        <tr>
                            <td>Blog Title</td>
                            <td><input type="text" class="col-sm-10 control-label" name="Blog_title"></td>
                        </tr>
                        <tr>
                            <td>Blog Description</td>
                            <td><textarea name="blog_description" rows="10" cols="80"></textarea></td>
                        </tr>
                        <tr>
