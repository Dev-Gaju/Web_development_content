                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    while ($blogs = mysqli_fetch_assoc($queryResult)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="Edit.php?id=<?php echo $blogs['id']; ?>" class="btn btn-primary btn-xs" title="view Blogs details">
                                    <span class="glyphicon glyphicon-zoom-in"></span>
                                </a>
                                <?php if ($blogs['publication_status']==1){ ?>
                                <a href="Edit.php?id=<?php echo $blogs['id']; ?>" class="btn btn-success btn-xs" title="published" >
                                    <span class="glyphicon glyphicon-arrow-up"></span>
                                </a>
                                <?php } else {?>
                                    <a href="Edit.php?id=<?php echo $blogs['id']; ?>" class="btn btn-danger btn-xs" title="published" >
                                        <span class="glyphicon glyphicon-arrow-up"></span>
                                    </a>

                                <?php } ?>
                                <a href="Edit.php?id=<?php echo $blogs['id']; ?>" class="btn btn-info btn-xs">
